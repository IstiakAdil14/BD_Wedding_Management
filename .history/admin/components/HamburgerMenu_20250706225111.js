...
const managementItems = [
  { label: "Dashboard", icon: <BuildIcon />, route: "/dashboard" },
  {
    ...
    submenu: [
      ...
      { label: "Event Gallery", route: "/home/event-gallery" },
  ...
  { label: "Blog", icon: <ArticleIcon />, route: "/blog" },
                    ...
                    {submenu && (
                      <>
                        <button
                          ...
                          onMouseEnter={typeof window !== "undefined" && window.innerWidth >= 528 ? (e) => handleSubmenuOpen(label, e) : undefined}
                          onMouseLeave={typeof window !== "undefined" && window.innerWidth >= 528 ? () => setOpenSubmenu(null) : undefined}
                        ...
                        >
                          ...
                          createPortal(
                            <motion.div
                              ...
                              onMouseEnter={typeof window !== "undefined" && window.innerWidth >= 768 ? () => setOpenSubmenu(label) : undefined}
                              onMouseLeave={typeof window !== "undefined" && window.innerWidth >= 768 ? () => setOpenSubmenu(null) : undefined}
                            >
                              {submenu.map(
