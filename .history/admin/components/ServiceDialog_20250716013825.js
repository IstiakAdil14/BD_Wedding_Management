...
export default function ServiceDialog({
  ...
  const [serviceData, setServiceData] = useState({
    _id: null,
    title: "",
    description: "", // will store raw JSON string of draft.js content
    price: "",
  ...
  useEffect(() => {
    if (initialData) {
      // Convert description from raw JSON string to EditorState
      let contentState;
      try {
        const rawContent = initialData.description
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-lg w-full shadow-lg overflow-auto max-h-[90vh] relative">
        ...
        >
          ...
          <div>
            ...
            <div className="w-full border border-gray-300 rounded bg-white text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 min-h-[150px] p-2">
              <Editor
          ...
          <div>
            ...
            <div className="flex items-center">
              <input
                ...
                inputMode="decimal"
              />
              <span className="ml-2 font-semibold">tk</span>
            </div>
          </div>
          <div>
