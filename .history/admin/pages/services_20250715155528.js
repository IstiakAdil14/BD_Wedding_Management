...
const CustomizeServiceDialog = dynamic(() => import("../components/CustomizeServiceDialog"), { ssr: false });
                ...
                >
                  <Editor
                    ...
                    toolbarClassName={`rdw-editor-toolbar ${
                      darkMode ? "rdw-editor-toolbar-dark" : "rdw-editor-toolbar-light"
                    }`}
                    wrapperClassName={`rdw-editor-wrapper ${
                      darkMode ? "rdw-editor-wrapper-dark" : "rdw-editor-wrapper-light"
                    }`}
                    editorClassName={`rdw-editor-main ${
                      darkMode ? "rdw-editor-main-dark" : "rdw-editor-main-light"
                    }`}
                        ...
                        {customizeServices.length > 0 &&
                          customizeServices.map((cs) => (
                            ...
                            >
                              ...
                              <td className="border px-2 py-2 text-gray-900 dark:text-gray-300">
                                <div
                                  dangerouslySetInnerHTML={{
                                    __html: (() => {
                                      try {
                                        if (
                                          ...
                                          (cs.categoryDescription.trim().startsWith("{") ||
                                            cs.categoryDescription.trim().startsWith("["))
                                        ) {
                                          const rawContent = JSON.parse(cs.categoryDescription);
                                          if (
                                            rawContent &&
                                            rawContent.blocks &&
                                            rawContent.entityMap !== undefined
...
<style jsx>{`
  ...
  /* Custom styles for react-draft-wysiwyg toolbar in light and dark mode */
  :global(.rdw-editor-toolbar-light) {
    background-color: #f0f0f0;
    border: 1px solid #ccc;
  }
  :global(.rdw-editor-toolbar-dark) {
    background-color: #2d3748;
    border: 1px solid #4a5568;
  }
  :global(.rdw-editor-wrapper-light) {
    background-color: white;
    border: 1px solid #ccc;
  }
  :global(.rdw-editor-wrapper-dark) {
    background-color: #1a202c;
    border: 1px solid #4a5568;
  }
  :global(.rdw-editor-main-light) {
    background-color: white;
    color: black;
    min-height: 150px;
    padding: 8px;
  }
  :global(.rdw-editor-main-dark) {
    background-color: #1a202c;
    color: #e2e8f0;
    min-height: 150px;
    padding: 8px;
