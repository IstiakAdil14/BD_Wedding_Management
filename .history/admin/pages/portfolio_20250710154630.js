...
const PortfolioPage = () => {
  ...
  const handleOpenDialog = (category = null) => {
    ...
    if (category && category.description && typeof category.description !== "string") {
      // Convert Draft.js raw content state to HTML string for dialog usage
      try {
        const descriptionHtml = draftToHtml(category.description);
        // Create a new category object with description as string
        const normalizedCategory = { ...category, description: descriptionHtml };
        setEditCategory(normalizedCategory);
      } catch (error) {
        console.error("Failed to convert description for editing", error);
