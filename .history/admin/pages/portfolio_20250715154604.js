...
const PortfolioPage = () => {
  ...
  // Determine max length for title column based on screen width
  console.log("Window width:", width, "Title max length:", width <= 480 ? 5 : 20);
  const titleMaxLength = width <= 480 ? 5 : 20;
                ...
                {events.length === 0 ? (
                  ...
                  events.map((event) => (
                    <tr key={event._id} className="hover:bg-gray-200">
                      <td className="border border-gray-300 px-4 py-2">
                        {truncateText(event.title, titleMaxLength)}
                      </td>
                      <td className="border border-gray-300 px-4 py-2">
                        {event.category}
                      </td>
