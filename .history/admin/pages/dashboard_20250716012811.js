...
export default function Dashboard() {
  ...
  const handleLogout = async () => {
    ...
    // The LogoutLoadingOverlay is rendered conditionally in the JSX based on isLoggingOut state
    await new Promise((resolve) => setTimeout(resolve, 2000));
    router.push("/");
  };

  // Overlay component for logout loading
  ...
  // Removed rendering of LogoutLoading component and conditional rendering for isLoggingOut
