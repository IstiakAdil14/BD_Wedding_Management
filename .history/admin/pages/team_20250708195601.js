              ...
              <div className="mb-3">
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    const editor = document.getElementById("ourStoryEditor");
                    if (editor) editor.focus();
                  }}
                >
                  <Editor
                    editorState={ourStoryEditorState}
                    onChange={setOurStoryEditorState}
              ...
              <div className="mb-3">
                ...
                >
                  <Editor
                    ...
                    onChange={setMissionEditorState}
                  ...
                  <tbody>
                    {teamMembers.map((member) => (
                      <tr
                        ...
                        className="hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                        <td className="px-1 py-2 border-b border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-gray-100 whitespace-nowrap">
                          {member.name}
                        </td>
                        <td className="px-1 py-2 border-b border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-gray-100 whitespace-nowrap">
                          {member.role}
                        </td>
                        <td className="px-1 py-2 border-b border-gray-300 dark:border-gray-600 text-sm text-gray-900 dark:text-gray-100">
                          {member.bio}
                        </td>
                        ...
                        <td className="px-1 py-2 border-b border-gray-300 dark:border-gray-600 text-sm whitespace-nowrap">
                        ...
                        <td className="px-1 py-2 border-b border-gray-300 dark:border-gray-600 text-center space-x-1 whitespace-nowrap">
                          <button
                            onClick={() => handleEditMember(member._id)}
                            className="px-1 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600 transition inline-flex items-center justify-center"
                            aria-label="Edit member"
                            title="Edit member"
                          >
                            <EditIcon />
                          ...
                          <button
                            onClick={() => handleDeleteMember(member._id)}
                            className="px-1 py-1 bg-red-600 text-white rounded hover:bg-red-700 transition inline-flex items-center justify-center"
                            aria-label="Delete member"
                            title="Delete member"
                          >
                            <DeleteIcon />
