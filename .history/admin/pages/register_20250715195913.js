...
const Register = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 border rounded shadow bg-gray-900 border-gray-700 text-gray-100">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full p-2 border rounded bg-gray-800 border-gray-600 text-gray-100"
          >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full p-2 border rounded bg-gray-800 border-gray-600 text-gray-100 placeholder-gray-400"
