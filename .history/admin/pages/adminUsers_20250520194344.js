      ...
      {selectedAdmin && (
        ...
        >
          ...
          >
            <button
              onClick={() => setSelectedAdmin(null)}
              className="absolute top-4 right-4 p-1 bg-blue-600 text-white rounded hover:bg-blue-700 transition flex items-center justify-center"
            >
              <CloseIcon />
            </button>
      ...
      {showImageViewer && (
        ...
        >
          ...
          >
            <button
              onClick={() => setShowImageViewer(false)}
              className="absolute top-2 right-2 p-1 bg-blue-600 text-white rounded hover:bg-blue-700 transition flex items-center justify-center"
            >
              <CloseIcon />
            </button>
            <img
