            ...
            <div>
              <table className="w-full table-auto border-collapse border border-gray-300">
                ...
                <tbody>
                  ...
                  <tr key={testimonial._id} className={`${darkMode ? "hover:bg-gray-700" : "hover:bg-gray-100"}`}>
                  ...
                  <td className="border border-gray-300 px-4 py-2 text-center">
                    <input
                      ...
                      onChange={() =>
                        handleDisplayToggle(testimonial._id, testimonial.display)
                      }
                    />
                  </td>
                  <td className="border border-gray-300 px-4 py-2">
                    <button
                      ...
                      className="px-3 py-1 mr-2 bg-blue-600 text-white rounded hover:bg-blue-700"
                    >
                      Edit
                    </button>
                    <button
