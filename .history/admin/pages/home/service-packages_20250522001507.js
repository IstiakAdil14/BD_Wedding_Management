...
const ServicesPage = () => {
  ...
  return (
    <div className="flex relative dark:bg-gray-900 dark:text-gray-100 min-h-screen">
      ...
      <main className="flex-grow p-6 ml-12 md:ml-0 bg-white dark:bg-gray-900">
        <h1 className="text-3xl font-bold mb-4 dark:text-white">Service Packages</h1>
        <button
        ...
        {loading ? (
          ...
          <p className="dark:text-gray-300">No services found.</p>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {services.map((service) => (
              <div
                key={service._id}
                className="border rounded p-4 shadow hover:shadow-lg transition dark:border-gray-700 dark:bg-gray-800 dark:hover:shadow-xl"
              >
                <h2 className="text-xl font-semibold mb-2 dark:text-white">{service.title}</h2>
                <p className="mb-2 dark:text-gray-300">{service.description}</p>
