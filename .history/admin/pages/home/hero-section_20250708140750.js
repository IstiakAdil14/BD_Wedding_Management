        ...
        >
          ...
          <motion.section className="mb-8" variants={itemVariants}>
            <div className="mb-4">
              ...
              >
                <Editor editorState={heroTitle} onChange={setHeroTitle} />
              </div>
            </div>
            <div className="mb-4">
              <label htmlFor="heroSubtitle" className="block font-semibold mb-1">
                Subtitle
              </label>
              <div
                id="heroSubtitle"
              ...
              >
                <Editor editorState={heroSubtitle} onChange={setHeroSubtitle} />
              </div>
            </div>
            <div className="mb-4">
