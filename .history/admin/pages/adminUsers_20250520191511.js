    ...
    >
      ...
      >
        ...
        {userRole === "Full Access" && (
          <div className="relative top-20 right-6 w-48 z-50">
            <button
              onClick={() => (window.location.href = "/signup")}
              className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-lg shadow-lg transition duration-300 flex items-center justify-center space-x-2"
            >
              <PersonAddIcon />
