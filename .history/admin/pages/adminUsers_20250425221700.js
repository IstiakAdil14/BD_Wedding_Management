  ...
  return (
    ...
    >
      ...
      <motion.main
        ...
        variants={itemVariants}
      >
        <motion.h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100" variants={itemVariants}>
        ...
        >
          ...
          <div className="mb-3 flex items-center space-x-4">
            ...
            <div>
              <p className="font-semibold text-lg text-gray-900 dark:text-gray-100">{loggedInAdmin.name}</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">{loggedInAdmin.email}</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Role: {loggedInAdmin.role}</p>
            </div>
          </div>
...
=======
      ...
      {showUpdateDialog && (
        ...
        >
          ...
          >
            <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">Update Profile</h2>
            <div className="mb-3">
      ...
      {showResetPasswordDialog && (
        ...
        >
          <div
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">Reset Password</h2>
            <div className="mb-3">
              <label className="block font-semibold mb-1 text-gray-900 dark:text-gray-100">Old Password</label>
              <input
                type="password"
                name="oldPassword"
            ...
            <div className="mb-3">
              <label className="block font-semibold mb-1 text-gray-900 dark:text-gray-100">New Password</label>
              <input
                type="password"
                name="newPassword"
            ...
            <div className="mb-3">
              <label className="block font-semibold mb-1 text-gray-900 dark:text-gray-100">Confirm Password</label>
              <input
                type="password"
      ...
      {showImageViewer && (
        ...
        >
          ...
          <button
            onClick={() => setShowImageViewer(false)}
            className="absolute top-4 right-4 px-3 py-1 bg-gray-700 text-white rounded hover:bg-gray-800 transition"
          >
            Close
          </button>
        </div>
