  ...
  return (
    <>
      ...
      <div className={`${darkMode ? "bg-gray-900 text-gray-100 min-h-screen" : "bg-white text-gray-900 min-h-screen"}`}>
        <div className={`max-w-md mx-auto mt-100 p-6 border rounded shadow ${darkMode ? "bg-gray-900 text-gray-100 border-gray-700" : "bg-white text-gray-900 border-gray-300"}`}>
