        ...
        >
          ...
          <div className="mb-3">
            ...
            <input
              ...
              readOnly
              className="w-full p-2 border rounded bg-gray-200 cursor-not-allowed dark:bg-gray-600 dark:text-gray-300"
            />
          </div>
          <div className="mb-3">
            <label className="block font-semibold mb-1 text-gray-900 dark:text-gray-100">Role</label>
            <input
              type="text"
              name="role"
              value={loggedInAdmin.role}
              readOnly
              className="w-full p-2 border rounded bg-gray-200 cursor-not-allowed dark:bg-gray-600 dark:text-gray-300"
            />
          </div>
          <div className="mb-3">
            <label className="block font-semibold mb-1 text-gray-900 dark:text-gray-100">Password</label>
            <input
              type="password"
              name="password"
