...
const ServicesPage = () => {
  ...
  const [clientTextEditorState, setClientTextEditorState] = useState(() => EditorState.createEmpty());
    ...
    const fetchClientTextContent = async () => {
      try {
        ...
        if (res.ok) {
          ...
          if (data && data.content) {
            const contentState = convertFromRaw(JSON.parse(data.content));
            setClientTextEditorState(EditorState.createWithContent(contentState));
          }
        } else {
    ...
    >
      <div className="flex flex-1 ">
        ...
        <div className="flex-1 ml-12 p-6 md:p-8">
          ...
          <div className="mb-4">
            <label className="block mb-1 font-semibold" htmlFor="editor">
              Description
            </label>
            <div
          ...
          {/* New draft.js textarea for client page text */}
          <div className="mb-4">
            <label className="block mb-1 font-semibold" htmlFor="clientTextEditor">
              Client Page Text
            </label>
            <div
              className={`border rounded p-2 min-h-[150px] ${
            ...
            >
              <Editor
                ...
                onChange={setClientTextEditorState}
                placeholder="Enter client page text here..."
              />
            </div>
            <button
