...
export default function Dashboard() {
  ...
  const userActivityData = [
    ...
    { name: "Apr", activeUsers: 50 },
    { name: "May", activeUsers: 70 },
    { name: "Jun", activeUsers: 90 },
  ];
      ...
      {showAdminProfile && (
        ...
        >
          ...
          >
            <button
              onClick={() => setShowAdminProfile(false)}
              className="absolute top-4 right-4 px-3 py-1 bg-green-600 text-white rounded hover:bg-green-700 transition font-bold text-lg"
            >
              X
            </button>
            <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">
      ...
      {showResetPasswordModal && (
        ...
        >
          ...
          >
            <button
              onClick={() => setShowResetPasswordModal(false)}
              className="absolute top-4 right-4 px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700 transition font-bold text-lg"
            >
              X
            </button>
            <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">
