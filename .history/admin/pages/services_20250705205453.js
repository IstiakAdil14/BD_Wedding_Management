        ...
        <div className="flex-1 ml-4">
          ...
          <div className="mb-4 flex items-center space-x-2">
            ...
            <button
              ...
              aria-label={showCustomizeServices ? "Hide Customized Services" : "Show Customized Services"}
          ...
          {loading ? (
            ...
            <>
              ...
              {showCustomizeServices && (
                <div>
                  <h2 className="text-2xl font-bold mb-4">Customized Services</h2>
                        ...
                        customizeServices.map((cs) => (
                          ...
                          >
                            ...
                            <td className="border px-4 py-2">
                              <button
                                onClick={() => handleCustomizeServiceClick(cs)}
