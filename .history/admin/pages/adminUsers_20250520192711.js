        ...
        {userRole === "Full Access" && (
          <div className="mb-4">
            <button
              ...
              className="w-48 bg-green-600 hover:bg-blue-700 text-white font-bold py-3 rounded-lg shadow-lg transition duration-300 flex items-center justify-center space-x-2"
            >
              <PersonAddIcon />
              <span>New Admin</span>
            </button>
