    ...
    >
      ...
      >
        ...
        <motion.section className="mb-6" variants={itemVariants}>
          <label className={`flex items-center space-x-3 ${darkMode ? "text-gray-100" : "text-gray-900"}`}>
            <input
              type="checkbox"
        ...
        <motion.section className="mb-6" variants={itemVariants}>
          <h2 className={`text-2xl font-semibold mb-4 ${darkMode ? "text-gray-100" : "text-gray-900"}`}>Logo</h2>
          <input type="file" accept="image/*" onChange={handleLogoChange} className={darkMode ? "text-gray-100" : "text-gray-900"} />
          {newLogo && (
            <img
              src={newLogo}
              alt="Logo"
        ...
        <motion.section className="mb-6" variants={itemVariants}>
          <h2 className={`text-2xl font-semibold mb-4 ${darkMode ? "text-gray-100" : "text-gray-900"}`}>Favicon</h2>
          <input type="file" accept="image/*" onChange={handleFaviconChange} className={darkMode ? "text-gray-100" : "text-gray-900"} />
          {newFavicon && (
            <img
              src={newFavicon}
              alt="Favicon"
        ...
        <motion.section className="mb-6" variants={itemVariants}>
          <label className={`block font-semibold mb-1 ${darkMode ? "text-gray-100" : "text-gray-900"}`}>Site Title</label>
          <input
            type="text"
            name="siteTitle"
            value={settings.siteTitle}
            onChange={handleInputChange}
            className={`w-full p-2 border rounded ${darkMode ? "text-gray-100 bg-gray-700 border-gray-600" : "text-gray-900 bg-white border-gray-300"}`}
          />
        </motion.section>

        <motion.section className="mb-6" variants={itemVariants}>
          <label className={`block font-semibold mb-1 ${darkMode ? "text-gray-100" : "text-gray-900"}`}>SEO Meta Title</label>
          <input
            type="text"
            name="seoMetaTitle"
        ...
        <motion.section className="mb-6" variants={itemVariants}>
          <label className={`block font-semibold mb-1 ${darkMode ? "text-gray-100" : "text-gray-900"}`}>
