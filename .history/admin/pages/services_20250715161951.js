                              ...
                              <td className="border px-2 py-2 text-gray-900 dark:text-gray-300 truncate-cell">
                                {windowWidth <= 640 ? (
                                  (() => {
                                    try {
                                      if (
                                        ...
                                        if (
                                          ...
                                          const truncated = plainText.length > 5 ? plainText.slice(0, 5) + "..." : plainText;
                                          return truncated;
                                        }
                                      }
                                    } catch (e) {
                                    ...
                                    const fallbackText = cs.categoryDescription || "";
                                    return fallbackText.length > 5 ? fallbackText.slice(0, 5) + "..." : fallbackText;
                                  })()
                                ) : (
                                  <div
                                    dangerouslySetInnerHTML={{
