    ...
    async function fetchAdmins() {
      try {
        ...
        if (Array.isArray(data)) {
          ...
          console.warn("Unexpected admin users data format:", data);
          setAdmins([]);
        }
      } catch (error) {
    ...
    >
      ...
      >
        ...
        {userRole === "Full Access" && (
          <div className="absolute top-36 right-6 w-36 z-50">
            <button
      ...
      {selectedAdmin && (
        ...
        >
          ...
          >
            <button
              onClick={() => setSelectedAdmin(null)}
              className="absolute top-4 right-4 p-1 bg-red-600 text-white rounded hover:bg-red-700 transition flex items-center justify-center"
            >
              <HighlightOffIcon />
            </button>
      ...
      {showImageViewer && (
        ...
        >
          ...
          >
            <button
              onClick={() => setShowImageViewer(false)}
              className="absolute top-2 right-2 p-1 bg-red-600 text-white rounded hover:bg-red-700 transition flex items-center justify-center"
            >
              <HighlightOffIcon />
            </button>
            <img
