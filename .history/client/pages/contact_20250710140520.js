...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col">
          ...
          >
            ...
            <div className="flex-grow space-y-4">
              ...
              <label className="block mt-4">
                ...
                <div className="mt-1 block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-blue-50 dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus-within:border-pink-500 focus-within:ring-2 focus-within:ring-pink-300 dark:focus-within:ring-pink-600 focus-within:ring-opacity-50 transition min-h-[250px] max-h-[400px] overflow-auto lg:min-h-[300px]">
                  <Editor
      ...
      <div className="w-full max-w-screen-xl mx-auto flex justify-center mt-2 mb-2">
        <a
          href="https://wa.me/8801234567890"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block bg-green-500 dark:bg-green-700 text-white px-6 py-1 rounded-full hover:bg-green-600 dark:hover:bg-green-800 transition mx-auto shadow-md hover:shadow-lg"
        >
