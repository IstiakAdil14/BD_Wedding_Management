...
const PackageDetails = () => {
  ...
  const [bookingDetails, setBookingDetails] = useState({
    ...
    paymentNumber: "", // new field for phone or account number input
  });
      ...
      const response = await fetch(
        `http://localhost:5000/api/services/${id}/book`,
        {
          ...
          body: JSON.stringify({
            ...
            accountNumber: bookingDetails.accountNumber,
            paymentNumber: bookingDetails.paymentNumber,
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            id="paymentNumber"
            name="paymentNumber"
            value={bookingDetails.paymentNumber}
            onChange={handleChange}
            required
            className="w-full p-2 border rounded bg-white dark:bg-gray-800 dark:text-white"
          />
