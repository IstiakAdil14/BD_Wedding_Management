...
const PackageDetails = () => {
  ...
  const paymentMethods = [
    { id: "visa", label: "Visa", imgSrc: "/payments/visa.png" },
    { id: "mastercard", label: "Mastercard", imgSrc: "/payments/mastercard.png" },
    { id: "amex", label: "American Express", imgSrc: "/payments/amex.png" },
    { id: "sslcommerz", label: "SSLCommerz", imgSrc: "/payments/sslcommerz.png" },
    { id: "bkash", label: "Bkash", imgSrc: "/payments/bkash.png" },
    { id: "nogod", label: "Nogod", imgSrc: "/payments/nogod.png" },
    { id: "paypal", label: "Paypal", imgSrc: "/payments/paypal.png" }
  ];
