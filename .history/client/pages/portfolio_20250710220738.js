          ...
          {selectedEvent && (
            ...
            >
              ...
              >
                <button
                  onClick={() => setSelectedEvent(null)}
                  className="absolute top-2 right-2 text-gray-600 dark:text-gray-300 hover:text-pink-600"
                  aria-label="Close"
                >
                  <CloseIcon />
                </button>
                <img
                  src={selectedEvent.images && selectedEvent.images.length > 0 ? selectedEvent.images[0] : ""}
