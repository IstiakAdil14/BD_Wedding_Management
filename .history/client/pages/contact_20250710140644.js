    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col">
      ...
      <div className="w-full max-w-screen-xl mx-auto flex justify-center mt-2 mb-0">
        <a
          ...
          className="inline-block bg-green-500 dark:bg-green-700 text-white px-6 py- rounded-full hover:bg-green-600 dark:hover:bg-green-800 transition mx-auto shadow-md hover:shadow-lg"
        >
