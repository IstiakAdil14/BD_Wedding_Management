e makimport React, { useState, useEffect } from "react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col">
      <main className="flex-grow max-w-6xl mx-auto p-8">
        ...
        <div className="mb-8 flex justify-start space-x-2 flex-nowrap overflow-x-auto scrollbar-none px-0 sm:space-x-4 sm:justify-center sm:flex-wrap sm:px-0">
        ...
        <div>
          <motion.div
            className="flex space-x-1 sm:space-x-2 overflow-x-scroll pb-4 scrollbar-none"
          ...
          >
            {filteredEvents.map((event) => (
              <motion.div
                key={event._id}
                className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 flex flex-col items-center text-center w-[calc(50vw-12px)] sm:w-[calc((100vw-64px)/5)] min-w-[calc(50vw-12px)] sm:min-w-[300px] flex-shrink-0 cursor-grab mt-4"
