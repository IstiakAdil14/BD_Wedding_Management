          ...
          >
            ...
            <div className="flex-grow space-y-4">
              ...
              <label className="block mt-4">
                ...
                <div className="mt-  block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-blue-50 dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus-within:border-pink-500 focus-within:ring-2 focus-within:ring-pink-300 dark:focus-within:ring-pink-600 focus-within:ring-opacity-50 transition min-h-[150px] max-h-[600px] overflow-auto">
                  <Editor
