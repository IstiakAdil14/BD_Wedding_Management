        ...
        >
          {testimonials.map((testimonial) => (
            ...
            >
              ...
              />
              <p className="italic text-gray-700 dark:text-gray-300 mb-4" dangerouslySetInnerHTML={{ __html: testimonial.message }} />
              ...
              >
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div
                      className="w-full p-2 border rounded bg-gray-100 dark:bg-gray-700 min-h-[100px] cursor-text resize-none"
                      onClick={() => {
