...
=======
          ...
          <input
            ...
            onChange={async (e) => {
              ...
              try {
                ...
                setDetails((prev) => ({ ...prev, profilePicture: data.filePath }));
              } catch (err) {
  ...
  // Removed handlePhoneChange function as onValueChange is handled inline now
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("/api/modernPersonalDetails", {
        method: "POST",
        headers: {
