      ...
      <div className="w-full max-w-screen-xl mx-auto flex justify-center mt-6 mb-6">
          {socialLinks.facebook && (
            <a
              ...
              className="inline-block bg-blue-600 dark:bg-blue-800 text-white px-6 py-3 rounded-full hover:bg-blue-700 dark:hover:bg-blue-900 transition mx-auto shadow-md hover:shadow-lg mb-4"
            >
              Facebook
            </a>
          )}
          {socialLinks.instagram && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-pink-600 dark:bg-pink-800 text-white px-6 py-3 rounded-full hover:bg-pink-700 dark:hover:bg-pink-900 transition mx-auto shadow-md hover:shadow-lg"
            >
              Instagram
            </a>
          )}
