        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <button
              ...
              className={`w-full bg-pink-600 dark:bg-pink-700 text-white py-3 text-lg rounded-lg transition mt-2 flex items-center justify-center gap-2 shadow-md hover:shadow-lg ${
