      ...
      >
        ...
        >
          {testimonials.map((testimonial) => (
            <motion.div
              key={testimonial._id}
              className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 flex flex-col items-center text-center w-[calc((100vw-96px)/3)] min-w-[300px] flex-shrink-0 cursor-grab mt-4"
