        ...
        <div>
          ...
          >
            {filteredEvents.map((event) => (
              <motion.div
                key={event._id}
              className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 flex flex-col items-center text-center w-[calc(50vw-16px)] sm:w-[calc((100vw-64px)/5)] min-w-[calc(50vw-16px)] sm:min-w-[300px] flex-shrink-0 cursor-grab mt-4"
