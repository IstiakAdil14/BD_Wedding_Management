    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col">
      <main className="flex-grow max-w-6xl mx-auto p-8">
          ...
          >
            {filteredEvents.map((event) => (
              ...
              >
                ...
                />
                <h3 className="text-xl font-semibold text-pink-700 dark:text-pink-200 mb-1">
                  {event.title}
                </h3>
        ...
        <AnimatePresence>
          {selectedEvent && (
            <motion.div
              className="absulate inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              <motion.div
                className="bg-white dark:bg-gray-900 rounded-lg overflow-hidden w-full max-w-7xl max-h-[90vh] relative"
                initial={{ scale: 0.8 }}
                animate={{ scale: 1 }}
                exit={{ scale: 0.8 }}
              ...
              >
                ...
                <div className="p-8 sm:p-12 max-w-4xl mx-auto">
                  ...
                  <p className="text-pink-600 dark:text-pink-400 mb-4 text-lg sm:text-xl">
                    {selectedEvent.category}
                  </p>
                  <p className="text-gray-800 dark:text-gray-200 whitespace-pre-wrap text-base sm:text-lg leading-relaxed">
                    {(() => {
                      try {
