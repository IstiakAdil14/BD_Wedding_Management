        ...
        <div
          ...
          onWheel={(e) => {
            if (e.currentTarget.contains(e.target)) {
              ...
              e.stopPropagation(); // Prevent sidebar scrolling when scrolling testimonials
              e.preventDefault(); // Disable page sidebar scrolling while scrolling testimonials
              return false; // Further prevent default scrolling behavior
            }
          }}
        >
