  ...
  return (
    <section id="testimonials" className="py-16 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="flex space-x-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-pink-400 scrollbar-track-pink-100 dark:scrollbar-thumb-pink-700 dark:scrollbar-track-pink-900">
          {testimonials.map((testimonial) => (
            <motion.div
              key={testimonial.id}
              className="bg-pink-50 dark:bg-pink-800 rounded-lg p-6 shadow-lg min-w-[280px] flex-shrink-0"
