...
const Navbar = () => {
  ...
  const handleLogout = () => {
    ...
    // Reload the page to reset app state and ensure UI updates
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <Link href="/" passHref>
              <span className="text-gray-800 dark:text-gray-200 hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 hover:bg-clip-text hover:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-pink-400 dark:hover:via-red-400 dark:hover:to-yellow-400 transition font-semibold cursor-pointer">
                Home
              </span>
            </Link>
            ...
            {!isRegistered ? (
              ...
              <>
                ...
                <button
                  className="flex items-center space-x-1 text-gray-800 dark:text-gray-200 hover:text-pink-500 dark:hover:text-pink-400 font-semibold ml-4"
                  aria-label="Signup"
                  onClick={handleSignupClick}
                >
                  <PersonAddIcon />
          ...
          <div className="bg-white dark:bg-gray-800 w-64 h-full p-4 space-y-4 shadow-lg overflow-auto">
            <Link href="/" legacyBehavior>
              <a
                ...
                className="block px-3 py-2 rounded-md text-base font-semibold text-gray-800 dark:text-gray-200 hover:bg-pink-500 hover:text-white transition"
              >
                Home
              </a>
            </Link>
            ...
            {isRegistered ? (
              <>
                ...
                <button
                  className="flex items-center space-x-1 text-gray-800 dark:text-gray-200 hover:bg-pink-500 hover:text-white rounded-md px-3 py-2 font-semibold ml-4"
                  aria-label="Signup"
                  onClick={() => {
                    setMobileMenuOpen(false);
                    handleSignupClick();
