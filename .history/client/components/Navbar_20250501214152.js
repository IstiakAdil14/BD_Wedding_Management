          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              {!isAuthenticated ? (
                ...
                <>
                  <Link href="/profile-register" passHref>
                    <span className="flex items-center space-x-2 px-3 py-1 text-gray-800 dark:text-gray-200 hover:bg-pink-100 dark:hover:bg-pink-700 hover:text-pink-600 dark:hover:text-pink-300 font-semibold rounded-md transition cursor-pointer">
                      <PersonAddIcon />
