    ...
    <nav className="bg-white dark:bg-gray-800 shadow-md relative z-50">
      <div className="w-full px-6">
        <div className="flex justify-between h-16 items-center max-w-full mx-auto">
          ...
          <div className="flex-shrink-0 flex items-center space-x-3 text-3xl font-extrabold text-pink-600">
            <EventIcon fontSize="large" />
            <span>BD Wedding Planner</span>
          </div>
          {/* Desktop menu */}
          <div className="hidden md:flex flex-grow justify-center space-x-12 items-center">
            <Link href="/" passHref>
          ...
          <div className="flex items-center space-x-6">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="p-3 rounded-full bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white shadow-lg focus:outline-none hover:from-pink-600 hover:via-red-600 hover:to-yellow-600 transition"
            ...
            {!isAuthenticated ? (
              <button
                className="text-gray-800 dark:text-gray-200 hover:text-pink-500 dark:hover:text-pink-400 font-semibold"
                aria-label="Login/Signup"
                onClick={handleLoginClick}
              >
                <LoginIcon className="inline mr-1" />
                <span>Login/Signup</span>
              </button>
            ) : (
              <button
