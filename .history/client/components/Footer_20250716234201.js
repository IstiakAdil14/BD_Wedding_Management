            ...
            <div className="w-1/2 pl-4">
              ...
              <div className="flex space-x-6">
                ...
                {socialLinks?.twitter && (
                  ...
                  >
                    <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
                      <path d="M22.675 0h-21.35C.597 0 0 .597 0 1.326v21.348C0 23.403.597 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.464.099 2.796.143v3.24h-1.92c-1.506 0-1.798.716-1.798 1.767v2.318h3.595l-.468 3.622h-3.127V24h6.127C23.403 24 24 23.403 24 22.674V1.326C24 .597 23.403 0 22.675 0z" />
                    </svg>
                  </a>
                )}
