    ...
    <nav className="bg-white dark:bg-gray-800 shadow-md relative z-50">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-30 z-40 md:hidden flex justify-start">
          <div className="bg-white dark:bg-gray-800 w-64 h-full p-6 space-y-6 shadow-lg overflow-auto">
            <Link href="/" legacyBehavior>
              <a
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center space-x-3 px-4 py-3 rounded-md text-base font-semibold text-gray-800 dark:text-gray-200 hover:bg-pink-100 dark:hover:bg-pink-700 hover:text-pink-600 dark:hover:text-pink-300 transition"
              >
                <HomeIcon fontSize="large" />
                <span>Home</span>
              </a>
