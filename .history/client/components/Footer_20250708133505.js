  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 mt-16">
        ...
        <div className="flex flex-col sm:hidden border-b border-gray-700 pb-6 mb-6">
          <div className="flex flex-row justify-between items-center">
            ...
            <div className="w-1/2 pr-4">
              ...
              <p className="text-sm leading-relaxed">{aboutUsText || "No About Us information available."}</p>
            </div>
            {/* Separator line */}
        ...
        <div className="hidden sm:grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="hidden sm:block border-r border-gray-700 pr-6">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/services" className="hover:text-pink-500 transition-colors duration-300">Services</a>
              </li>
              <li>
                <a href="/portfolio" className="hover:text-pink-500 transition-colors duration-300">Portfolio</a>
              </li>
              <li>
      ...
      <div className="mt-10 border-t border-gray-800 pt-6 text-center text-xs text-gray-500">
        &copy; {new Date().getFullYear()} BD Wedding Planner. All rights reserved.
      </div>
    </footer>
  );
};
