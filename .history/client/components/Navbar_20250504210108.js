...
const LogoutLoadingOverlay = () => {
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center backdrop-blur-md bg-white bg-opacity-80 animate-fadeIn">
      <div className="bg-white bg-opacity-90 dark:bg-gray-900 dark:bg-opacity-90 p-12 rounded-3xl shadow-[0_0_20px_rgba(124,58,237,0.7)] w-full max-w-md text-center transition-transform transform hover:scale-105">
