      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <Link href="/" passHref>
              <span
                className="flex items-center space-x-1 text-gray-800 dark:text-gray-200 hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 hover:bg-clip-text hover:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-pink-400 dark:hover:via-red-400 dark:hover:to-yellow-400 transition font-semibold cursor-pointer"
              >
            ...
            <Link href="/about" passHref>
              <span
                className="flex items-center space-x-1 text-gray-800 dark:text-gray-200 hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 hover:bg-clip-text hover:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-pink-400 dark:hover:via-red-400 dark:hover:to-yellow-400 transition font-semibold cursor-pointer"
              >
                <InfoIcon fontSize="large" titleAccess="About" />
              </span>
            </Link>
            <Link href="/services" passHref>
              <span
                className="flex items-center space-x-1 text-gray-800 dark:text-gray-200 hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 hover:bg-clip-text hover:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-pink-400 dark:hover:via-red-400 dark:hover:to-yellow-400 transition font-semibold cursor-pointer"
              >
                <BuildIcon fontSize="large" titleAccess="Services" />
              </span>
            </Link>
            <Link href="/portfolio" passHref>
              <span
                className="flex items-center space-x-1 text-gray-800 dark:text-gray-200 hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 hover:bg-clip-text hover:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-pink-400 dark:hover:via-red-400 dark:hover:to-yellow-400 transition font-semibold cursor-pointer"
              >
                <PhotoLibraryIcon fontSize="large" titleAccess="Portfolio" />
              </span>
            </Link>
            <Link href="/testimonials" passHref>
              <span
                className="flex items-center space-x-1 text-gray-800 dark:text-gray-200 hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 hover:bg-clip-text hover:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-pink-400 dark:hover:via-red-400 dark:hover:to-yellow-400 transition font-semibold cursor-pointer"
              >
                <CommentIcon fontSize="large" titleAccess="Testimonials" />
              </span>
            </Link>
            <Link href="/contact" passHref>
              <span
                className="flex items-center space-x-1 text-gray-800 dark:text-gray-200 hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 hover:bg-clip-text hover:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-pink-400 dark:hover:via-red-400 dark:hover:to-yellow-400 transition font-semibold cursor-pointer"
              >
                <ContactMailIcon fontSize="large" titleAccess="Contact" />
              </span>
            </Link>
