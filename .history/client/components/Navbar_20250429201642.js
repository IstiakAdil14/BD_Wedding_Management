...
const LogoutLoadingOverlay = () => {
  return (
    <div className="min-h-screen flex items-center justify-center animate-fadeIn" style={{background: 'linear-gradient(to right, #f87171, #dc2626, #db2777)', backdropFilter: 'blur(10px)'}}>
