            ...
            <div className="flex items-center space-x-4">
              ...
              {isAuthenticated && passwordSet && (
                <div className="relative group">
                  ...
                  <div className="absolute left-0 mt-2 w-40 bg-white dark:bg-gray-700 rounded-md shadow-lg opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-opacity duration-200 z-50">
                    <Link
                      href="/dashboard"
