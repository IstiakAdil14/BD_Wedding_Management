...
const LogoutLoadingOverlay = () => {
  return (
    <div className="min-h-screen flex items-center justify-center animate-fadeIn" style={{backgroundColor: 'rgba(220, 38, 38, 0.3)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)'}}>
      <div className="bg-white bg-opacity-90 dark:bg-gray-900 dark:bg-opacity-90 p-12 rounded-3xl shadow-[0_0_20px_rgba(220,38,38,0.7)] w-full max-w-md text-center transition-transform transform hover:scale-105">
