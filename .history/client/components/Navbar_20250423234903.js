    ...
    <nav className="bg-white dark:bg-gray-800 shadow-md">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white dark:bg-gray-800 px-2 pt-2 pb-3 space-y-1 shadow-md">
          <Link href="/" legacyBehavior>
            <a className="block px-3 py-2 rounded-md text-base font-semibold text-gray-800 dark:text-gray-200 hover:bg-pink-500 hover:text-white transition">Home</a>
          </Link>
          <Link href="/about" legacyBehavior>
            <a className="block px-3 py-2 rounded-md text-base font-semibold text-gray-800 dark:text-gray-200 hover:bg-pink-500 hover:text-white transition">About</a>
          </Link>
          <Link href="/services" legacyBehavior>
            <a className="block px-3 py-2 rounded-md text-base font-semibold text-gray-800 dark:text-gray-200 hover:bg-pink-500 hover:text-white transition">Services</a>
          </Link>
          <Link href="/portfolio" legacyBehavior>
            <a className="block px-3 py-2 rounded-md text-base font-semibold text-gray-800 dark:text-gray-200 hover:bg-pink-500 hover:text-white transition">Portfolio</a>
          </Link>
          <Link href="/testimonials" legacyBehavior>
            <a className="block px-3 py-2 rounded-md text-base font-semibold text-gray-800 dark:text-gray-200 hover:bg-pink-500 hover:text-white transition">Testimonials</a>
          </Link>
          <Link href="/contact" legacyBehavior>
            <a className="block px-3 py-2 rounded-md text-base font-semibold text-gray-800 dark:text-gray-200 hover:bg-pink-500 hover:text-white transition">Contact</a>
          </Link>
        </div>
      )}
    </nav>
