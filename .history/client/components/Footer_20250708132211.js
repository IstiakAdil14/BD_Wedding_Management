...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 mt-16">
      ...
      {/* Desktop and Tablet grid container */}
      <div className="hidden sm:grid grid-cols-3 gap-8 border-b border-gray-700 pb-6 mb-6">
        {/* About Us */}
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {quickLinks?.map((link, index) => (
              <li key={index}>
                <a href={link.url} className="text-gray-400 hover:text-pink-500 transition-colors duration-300">
                  {link.text}
                </a>
              </li>
            ))}
