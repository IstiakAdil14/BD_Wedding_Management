      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <Link href="/" passHref>
              <span className="flex items-center space-x-2 text-gray-800 dark:text-gray-200 hover:bg-gradient-to-r hover:from-pink-500 hover:via-red-500 hover:to-yellow-500 hover:bg-clip-text hover:text-transparent dark:hover:bg-gradient-to-r dark:hover:from-pink-400 dark:hover:via-red-400 dark:hover:to-yellow-400 transition font-semibold cursor-pointer">
            ...
            {!isAuthenticated ? (
              <button
                className="flex items-center space-x-2 px-3 py-1 text-gray-800 dark:text-gray-200 hover:text-pink-500 dark:hover:text-pink-400 font-semibold rounded-md transition"
