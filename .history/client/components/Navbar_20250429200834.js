...
const LogoutLoadingOverlay = () => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-red-100 dark:bg-red-900 bg-opacity-80 dark:bg-opacity-80 animate-fadeIn">
      <div className="bg-white dark:bg-gray-800 p-10 rounded-xl shadow-lg flex flex-col items-center space-y-6">
        <LogoutIcon className="text-red-600 dark:text-red-400" style={{ fontSize: 60 }} />
        <h2 className="text-3xl font-bold text-red-700 dark:text-red-300">Logging Out...</h2>
        <p className="text-red-600 dark:text-red-400 text-lg">Please wait while we securely log you out.</p>
        <div className="w-48 h-2 bg-red-300 dark:bg-red-700 rounded-full overflow-hidden">
          <div className="h-full bg-red-600 dark:bg-red-400 animate-progressBar"></div>
        </div>
      </div>
      <style jsx>{`
        @keyframes fadeIn {
