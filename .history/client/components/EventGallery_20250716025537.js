...
const EventGallery = () => {
  ...
  // Flatten images from filtered events and deduplicate by src
  ...
  // Deduplicate images by src and use src as id for uniqueness
  ...
  for (const img of allImages) {
    if (!seenSrc.has(img.src)) {
      ...
      filteredImages.push({
        ...img,
        id: img.src, // use src as id to avoid React key duplication issues
      });
    }
  }
