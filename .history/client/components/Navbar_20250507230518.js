...
const LogoutLoadingOverlay = () => {
  return (
    <div className="fixed inset-0 z-80 flex items-center justify-center backdrop-blur-md bg-white animate-fadeIn">
      <div className="bg-white dark:bg-gray-900 p-12 rounded-3xl shadow-[0_0_20px_rgba(124,58,237,0.7)] w-full max-w-md text-center transition-transform transform hover:scale-105 z-90">
...
const Navbar = () => {
  ...
  const { isAuthenticated, logout, setLoggingOut } = useAuth();
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-2 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 transition focus:outline-none"
                  aria-label="Profile"
                >
                  <img
                ...
                {profileMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-md py-2 z-50">
                    ...
                    <button
                      ...
                      className="block w-full text-left px-4 py-2 text-red-700 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-700 transition"
                    >
                      Logout
                    </button>
                  </div>
