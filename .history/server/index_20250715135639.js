...
app.post("/api/client/login", express.json(), async (req, res) => {
  ...
  try {
    ...
    // Log login event
    try {
      await AuthEvent.create({ eventType: "login", userEmail: email });
    } catch (logError) {
...
const statsRouter = require("./routes/api/admin/stats");
app.use("/api/admin/stats", statsRouter);

const servicesByCategoryRouter = require("./routes/api/admin/servicesByCategory");
app.use("/api/admin/servicesByCategory", servicesByCategoryRouter);

const authEventStatsRouter = require("./routes/api/admin/authEventStats");
app.use("/api/admin/authEventStats", authEventStatsRouter);
...
const clientTextContentRouter = require("./routes/api/clientTextContent");
const eventsRouter = require("./routes/api/events");
const uploadVideoRouter = require("./routes/api/uploadVideo");
...
app.use("/api/clientTextContent", clientTextContentRouter);
